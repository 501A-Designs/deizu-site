    ...
    return (
        ...
        >
            <AlignItems style={{justifyContent: 'space-between'}}>
                <AlignItems gap={'1em'}>
                    {props.imageSource ? 
                        <img alt="no img found" style={sheetButtonImageStyle} src={props.imageSource} />:
                        <img style={sheetButtonImageStyle} src={`https://avatars.dicebear.com/api/jdenticon/${props.imageSource}.svg`} />
                    }
                    <AlignItems>
                        <p 
                            style={{
